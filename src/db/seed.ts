...
const seedRaffles = [
	...
	},
	{
		...
		description: "Draws 1 minutes after seeding",
	...
	},
	{
		...
		name: "Five Minute Draw Raffle",
		description: "Draws five minutes after seeding",
		prizeId: seedPrizes[0].id,
		ticketPrice: "2.00",
		maxTickets: 100,
		drawDate: minutesFromNow(5),
		status: "active" as const,
		winnerId: null,
	},
	{
		id: "854c8d65-3fcb-4b6e-88e5-d75f63067b16",
		name: "11 Minute Draw Raffle",
		description: "Draws 11 minutes after seeding",
		prizeId: seedPrizes[1].id,
		ticketPrice: "2.00",
		maxTickets: 100,
		drawDate: minutesFromNow(11),
		status: "active" as const,
		winnerId: null,
	},
];
